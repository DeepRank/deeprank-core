...
cysteine = AminoAcid("Cysteine", "CYS", "C", charge=-0.64, polarity=Polarity.POLAR, size=2, count_hydrogen_bond_donors=1, count_hydrogen_bond_acceptors=2, index=1)
...
glutamate = AminoAcid("Glutamate", "GLU", "E", charge=-1.37, polarity=Polarity.NEGATIVE_CHARGE, size=5, count_hydrogen_bond_donors=1, count_hydrogen_bond_acceptors=2, index=3)
...
histidine = AminoAcid("Histidine", "HIS", "H", charge=-0.29, polarity=Polarity.POLAR, size=6, count_hydrogen_bond_donors=1, count_hydrogen_bond_acceptors=1, index=6)
...
tryptophan = AminoAcid("Tryptophan", "TRP", "W", charge=-0.79, polarity=Polarity.POLAR, size=10, count_hydrogen_bond_donors=1, count_hydrogen_bond_acceptors=1, index=14)
tyrosine = AminoAcid("Tyrosine", "TYR", "Y", charge=-0.80, polarity=Polarity.POLAR, size=8, count_hydrogen_bond_donors=0, count_hydrogen_bond_acceptors=0, index=15)
...
arginine = AminoAcid("Arginine", "ARG", "R", charge=-1.65, polarity=Polarity.POSITIVE_CHARGE, size=7, count_hydrogen_bond_donors=5, count_hydrogen_bond_acceptors=3, index=17)
asparagine = AminoAcid("Asparagine", "ASN", "N", charge=-1.22, polarity=Polarity.POLAR, size=4, count_hydrogen_bond_donors=2, count_hydrogen_bond_acceptors=3, index=18)
glutamine = AminoAcid("Glutamine", "GLN", "Q", charge=-1.22, polarity=Polarity.POLAR, size=5, count_hydrogen_bond_donors=2, count_hydrogen_bond_acceptors=3, index=19)
